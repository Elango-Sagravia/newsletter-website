...
export default function Home({ params }) {
  ...
  return (
    <>
      <section
        className={`w-full md:w-3/5 lg:w-1/2 px-8 md:px-0 mx-auto pt-16 pb-16 md:pt-32 ${
      ...
      {!isSubscribed && (
        <section className="bg-gradient-to-t	from-nl_sec_background to-white px-8 pt-4 pb-16 md:py-16 md:px-16">
          <div className="w-full md:w-4/5 lg:w-3/5 mx-auto">
            <h3 className="text-4xl text-nl_background md:text-center">
              Subscribe for free today and receive way more insights.
            </h3>
